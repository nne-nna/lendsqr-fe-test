...
const UserDetails = () => {
  ...
  if (loading) return <div className="user-details"><div className="container">Loading...</div></div>
  if (!user) return <div className="user-details"><div className="container">User not found.</div></div>
